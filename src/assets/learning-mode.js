(function(root){
  "use strict";
  const homePath = new URL("../index.html", document.currentScript.src).pathname;
  ...
  function set(next) {
    ...
    document.querySelectorAll('a[href]').forEach(link => {
      ...
      if (target.pathname !== homePath && !decodeURIComponent(target.pathname).endsWith('/Masters of IGCSE Chemistry.html')) return;
